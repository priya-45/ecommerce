...
class ChangePasswordForm(PasswordChangeForm):
    old_password = forms.CharField(strip=False, label="Old Password", 
    widget = forms.PasswordInput(attrs={"autocomplete":"current_password","autofocus":True,
    'class':"form-control"}))

    new_password1 = forms.CharField(strip=False, label="New Password", 
    widget = forms.PasswordInput(attrs={"autocomplete":"new-password","class":"form-control"}),
    help_text=password_validation.password_validators_help_text_html())

    new_password2 = forms.CharField(strip=False, label="Confirm Password", widget=forms.PasswordInput
...
class SetPassword(SetPasswordForm):
    ...
    new_password2 = forms.CharField(strip=False, label="Confirm New Password", widget=forms.PasswordInput
    (attrs={"autocomplete":"new-password","class":"form-control"}))
